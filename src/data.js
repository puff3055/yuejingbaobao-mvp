...
export const CARE_GIFTS = [
  ...
  { id: "meeting", title: "汇报前十分钟缓冲", kind: "根据妳的现实任务生成", how: "如果条件允许，在汇报前留出 10 分钟：坐下、喝几口温水、调整衣物或低温热源，并准备一句需要暂停时的说明。", feedbackAfter: "汇报结束后", source: "妳的“下午三点必须汇报”这一处境；不是群体周期处方", caution: "它只降低当下负担，不要求妳硬撑，也不替代对持续、加重或异常疼痛的评估。", icon: "time" },
